...
Our first explanatory variable, sidewalk area, is calculated as the total curb-to-building sidewalk area (in square kilometers) within the [UHF](https://www.nyc.gov/assets/doh/downloads/pdf/survey/uhf_map_100604.pdf) neighborhood and borough, divided by the total land area (excluding inland water bodies), and expressed as a percentage.
...
p1_plotly = plot_ly(data = commute_long,
  ...
  layout(
    title = "Commuting Methods by Borough",
    xaxis = list(
        title = "Commute Mode", 
        tickangle = 45,
        ticktext = c("Bicycle", "Car/Truck/Van", "Public Transit", "Walking"),
        tickvals = c("bicycle", "car_truck_or_van", "public_transportation", "walked")
    ),
...
Navigate through NYC's health indicators using our interactive [Shiny](https://xiii11.shinyapps.io/p8105_activelivingproject/) platform. Compare obesity rates and sidewalk coverage between neighborhoods and boroughs to understand urban health patterns.
