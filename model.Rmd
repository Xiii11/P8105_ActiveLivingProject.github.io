...
Next, we are curious whether there are interaction effects between sidewalk area percentage and walking commuter rates on obesity rates. An interaction model was built to explore whether the effect of sidewalk area percentage on obesity depends on walking commuter rates.
